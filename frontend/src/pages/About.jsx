...
import { Globe, Coffee, Store, ShieldCheck, Heart, ArrowRight } from 'lucide-react';
import logoImg from '../assets/logo.png';

export default function About() {
  return (
    <div className="pt-28 sm:pt-36 pb-24 px-6 sm:px-8 max-w-6xl mx-auto space-y-16 font-body text-[#1C1714]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-white border border-[#EDE4D8] rounded-sm p-8 sm:p-12 shadow-xs">
        ...
        <div className="lg:col-span-6 space-y-5">
          ...
          <h2 className="font-display text-2xl sm:text-3xl text-[#24150F] leading-tight">
      ...
      <div className="bg-white border border-[#EDE4D8] rounded-sm p-8 sm:p-12 shadow-xs space-y-6">
        <div className="flex items-center gap-3">
          <Globe className="w-6 h-6 text-[#B8895B]" />
          <h2 className="font-display text-2xl sm:text-3xl text-[#24150F]">
            1,400+ Stores In Nearly 40 Countries
          </h2>
        </div>
        <p className="text-sm sm:text-base text-[#5A3825] leading-relaxed font-normal">
      ...
      <div className="bg-[#EDE4D8]/80 border border-[#EDE4D8] rounded-sm p-8 sm:p-12 shadow-xs text-center space-y-6">
        <span className="text-[10px] tracking-[0.3em] uppercase font-semibold text-[#B8895B] block">
          THE PAKISTAN COMMITMENT
        </span>
        <blockquote className="font-display text-xl sm:text-2xl text-[#24150F] max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="pt-2">
          ...
          >
            Explore Pakistan Lounges <ArrowRight className="w-4 h-4 text-[#B8895B]" />
          </Link>
        </div>
      </div>
